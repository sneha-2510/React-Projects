    ...
    <div className='w-full h-screen duration-200'
      ...
      <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
        ...
        <div className='flex flex-wrap  justify-center gap-3 shadow-xl bg-white px-3 py-2 rounded-3xl'>
          ...
          <button onClick={ ()=> setColor("cyan")} className='outline-none px-4 py-1 rounded-full text-black shadow-xl' style={{ backgroundColor: "cyan" }}>Cyan</button>
          ...
          <button onClick={ ()=> setColor("brown")} className='outline-none px-4 py-1 rounded-full text-white shadow-xl' style={{ backgroundColor: "brown" }}>Brown</button>
        </div>
      </div>
    </div>
  )
